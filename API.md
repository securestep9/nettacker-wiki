WebUI/API Manual usage explained in the [Usage](https://github.com/zdresearch/OWASP-Nettacker/wiki/Usage#api-and-webui) page but let's get into the structure of the request now.
